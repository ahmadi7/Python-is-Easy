...
class Artist:
    ...
    Attributes:
        ...
        albums (List[Album]): A list of the albums by the artist.
            The list includes only those album in this collection, it is not
    ...
    def add_album(self, album):
        ...
        Args:
            album (Album): Album object to add to the list.
                If the album is already present, it will not be added again (yet to be implemented)
        """
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            if new_album is None:
                ...
                # otherwise create a new album object and store in artist's collection
